...
if __name__ == '__main__':
    ...
    prefix = 'data/'
    plotFolder = "graphs/"
    fileName = '{}_{}.txt'.format("NeuralNetworkParamTuningSelectGrid", time.strftime('%d-%m-%Y_%Hh%M'))
    ...
    with measure_time('Random Search'):
        ...
        estim = MLPRegressor()
        grid_search = GridSearchCV(estimator = estim, param_grid = param_grid, cv = 3, n_jobs = -1, verbose = 2)
